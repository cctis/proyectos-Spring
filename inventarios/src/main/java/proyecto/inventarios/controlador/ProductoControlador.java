package proyecto.inventarios.controlador;
...
import proyecto.inventarios.servicio.ProductoServicio;
...
public class ProductoControlador {
    ...
    public ResponseEntity<Producto> obtenerProductoPorId(@PathVariable int id){
        ...
        if(producto != null)
          ...
          throw new RecursoNoEncontradoExcepcion("No se encuentra el recuso con id: " + id);
    }
